...
public abstract class TokenProvider {
     ...
     * @param sharedAccessSignature The signature associated with the SharedAccessKeyAuthorizationRule
    ...
    /**
     * Construct a TokenProvider based on the provided Key Name and Shared Access Key.
     * @param keyName The key name of the corresponding SharedAccessKeyAuthorizationRule.
     * @param sharedAccessKey The key associated with the SharedAccessKeyAuthorizationRule
     ...
     * @return Returns a CompletableFuture of the SecutiryToken that completes once generated
     */
