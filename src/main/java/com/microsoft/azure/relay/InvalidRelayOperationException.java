...
public class InvalidRelayOperationException extends RuntimeException {
    ...
    /**
     * Creates a new instance of the InvalidOperationException class with a specified error message.
    ...
    /**
     * Creates a new instance of the InvalidOperationException class with a specified error message and a reference to the inner exception that is the cause of this exception.
     * @param message The message that describes the error.
     ...
     * @param message The message that describes the error.
     * @param innerException The exception that is the cause of the current exception.
     * @param isTransient Whether this exception is transient and should be retried.
     */
